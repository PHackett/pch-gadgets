...
public class BattingMatchData
{
	...
	public boolean ParseFromXML (Element aBattingElement, String aKey)
	{
		boolean 	lRet=false;
        NodeList	lBMD=aBattingElement.getElementsByTagName(aKey);
        
        if (lBMD.getLength() != 1)
        {
        	System.out.println ("ERROR: We have " + lBMD.getLength() + " '" + aKey + "' records");
        	lRet = false;	        	
        }
        else
        {
        	Element lBElement = (Element)lBMD.item(0);

        	//
        	// First matchID - "<MatchId date="Sun Aug 1 00:00:00 UTC+0100 2010" oppo="Theale and Tilehurst"/>"
        	//
        	NodeList	lMID=lBElement.getElementsByTagName("MatchId");
            ...
            //
        	NodeList	lBD=lBElement.getElementsByTagName("BattingData");
